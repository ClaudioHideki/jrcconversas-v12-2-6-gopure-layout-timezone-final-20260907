...
class Whatsapp::CallPermissionRequestService
  ...
  def perform
    # Conversations receive display_id from a database trigger after insert. Reloading
    # clears that trigger-populated dirty attribute before Active Record acquires a lock.

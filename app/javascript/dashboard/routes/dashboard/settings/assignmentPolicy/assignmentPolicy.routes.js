...
const superAdminAssignmentMeta = {
  ...assignmentMeta,
...
export default {
  routes: [
    ...
    {
      path: '/super_admin/accounts/:accountId/settings/assignment-policy',
      component: SettingsWrapper,
      ...
      children: [
        {
          path: '',
          redirect: to => ({
            name: 'super_admin_assignment_policy_index',
            params: to.params,
          }),
        },
        {
          ...
          name: 'super_admin_assignment_policy_index',
          component: AssignmentPolicyIndex,
          meta: superAdminAssignmentMeta,
        },
        {
          path: 'assignment',
          name: 'super_admin_agent_assignment_policy_index',
          component: AgentAssignmentIndex,
          meta: superAdminAssignmentMeta,
        },
        {
          path: 'assignment/create',
          name: 'super_admin_agent_assignment_policy_create',
          component: AgentAssignmentCreate,
          meta: superAdminAssignmentMeta,
        },
        {
          path: 'assignment/edit/:id',
          name: 'super_admin_agent_assignment_policy_edit',
          component: AgentAssignmentEdit,
          meta: superAdminAssignmentMeta,
        },
      ],

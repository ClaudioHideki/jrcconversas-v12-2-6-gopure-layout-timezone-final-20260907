...
<template>
  <ReportHeader v-if="!embedded" :header-title="$t('REPORT.HEADER')">
    <V4Button
  ...
  <div
    v-else
    class="flex flex-col gap-3 border-b border-n-weak pb-4 sm:flex-row sm:items-center sm:justify-between"
  >
    <div>

...
import OperationalLiveReports from './OperationalLiveReports.vue';
  ...
  routes: [
    {
      ...
      children: [
        ...
        {
          path: 'operational-live',
          name: 'operational_live_reports',
          meta,
          component: OperationalLiveReports,
        },
        {
          path: 'conversation',

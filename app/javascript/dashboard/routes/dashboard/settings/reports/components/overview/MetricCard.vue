...
const toneClasses = {
  blue: 'border-n-blue-5 bg-gradient-to-br from-n-blue-2 to-n-solid-1',
  teal: 'border-n-teal-5 bg-gradient-to-br from-n-teal-2 to-n-solid-1',
  violet: 'border-n-violet-5 bg-gradient-to-br from-n-violet-2 to-n-solid-1',
  amber: 'border-n-amber-5 bg-gradient-to-br from-n-amber-2 to-n-solid-1',
};
</script>

<template>
  <div
    class="m-0.5 flex min-h-[10rem] flex-grow flex-col rounded-2xl border px-6 py-5 text-n-slate-12 shadow-sm"
    :class="toneClasses[tone] || toneClasses.blue"
  >
    <div

...
const isWhatsappCall = computed(
  () => props.call?.provider === VOICE_CALL_PROVIDERS.WHATSAPP
);
    ...
    <div class="flex flex-col gap-3 pb-3 border-b border-n-call-widget-border">
      <div class="flex items-center gap-2 px-4">
        ...
        <div v-else class="flex items-center gap-1.5 shrink-0">
          ...
          <NextButton
            v-if="isIncoming && !isWhatsappCall"
      ...
      <div class="flex items-center gap-3 px-4">
        ...
        <div class="flex-1 min-w-0">
          ...
          <p
            v-if="isWhatsappCall"
            class="mt-1 text-xs font-medium text-n-teal-9"
          >
            {{ $t('CONVERSATION.VOICE_WIDGET.WHATSAPP_CALLING') }}
          </p>
        </div>
        ...
        <div class="flex items-center gap-2 shrink-0">
          ...
          <NextButton
            ...
            :label="
              isWhatsappCall ? $t('CONVERSATION.VOICE_WIDGET.ANSWER_CALL') : ''
            "
            :size="isWhatsappCall ? 'lg' : null"
            teal
            :class="isWhatsappCall ? '!rounded-xl' : '!rounded-full'"
            @click="$emit('accept')"
          />
          ...
          <NextButton
            ...
            "
            :icon="
              isWhatsappCall && isIncoming
                ? 'i-ph-phone-disconnect-bold'
                : 'i-ph-phone-bold'
            "
            :label="
              isWhatsappCall && isIncoming
                ...
                : ''
            "
            :size="isWhatsappCall && isIncoming ? 'lg' : null"
            ruby
            :class="
              isWhatsappCall && isIncoming
                ? '!rounded-xl'
                : '!rounded-full rotate-[135deg]'
            "

...
const props = defineProps({
  ...
  ignoreFeatureFlag: { type: Boolean, default: false },
});
...
<template>
  <Policy
    v-if="disabled || !hasChildren || hasAccessibleChildren"
    :permissions="resolvePermissions(to)"
    :feature-flag="ignoreFeatureFlag ? undefined : resolveFeatureFlag(to)"
    as="li"
  ...
  >
    ...
    <template v-if="isCollapsed">
      ...
      >
        <component
          :is="to && !hasChildren && !disabled ? 'router-link' : 'button'"
          ref="triggerRef"
          :to="to && !hasChildren && !disabled ? to : undefined"
          type="button"

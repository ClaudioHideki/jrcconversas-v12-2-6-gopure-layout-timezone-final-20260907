      ...
      <div class="p-6 h-[450px] bg-n-background">
        <div class="flex gap-8">
          <FeatureSpotlightPopover
            ...
            title="Assistente JRC"
            note="Assistente JRC engages directly with customers, learns from your help docs and past conversations, and delivers instant, accurate responses. It handles the initial queries, providing quick resolutions before transferring to an agent when needed."
            video-url=""
            thumbnail=""

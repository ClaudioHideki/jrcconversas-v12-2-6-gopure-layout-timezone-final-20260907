...
<template>
  ...
  >
    <Button
      v-tooltip.top="
        $t('CONVERSATION.CONVERSATION_SIDEBAR.ACCORDION.CONTACT_DETAILS')
      "
      :aria-label="
        $t('CONVERSATION.CONVERSATION_SIDEBAR.ACCORDION.CONTACT_DETAILS')
      "
      :title="$t('CONVERSATION.CONVERSATION_SIDEBAR.ACCORDION.CONTACT_DETAILS')"
      data-testid="open-contact-panel"
      faded
      blue
      sm
      class="!rounded-full shadow-sm transition-all duration-[250ms] ease-out hover:shadow active:!scale-95 active:!brightness-105 active:duration-75"
      :class="{

...
<template>
  <section
    class="flex w-full h-full overflow-hidden justify-center bg-n-surface-1"
  >
    <div
      class="flex min-w-0 flex-1 flex-col h-full transition-all duration-300"
    >
      <header class="sticky top-0 z-10 px-6 3xl:px-0">
        <div class="w-full mx-auto max-w-[46rem]">
          <div
      ...
      <main class="flex-1 px-6 overflow-y-auto 3xl:px-px">
        <div class="w-full py-4 mx-auto max-w-[46rem]">
          <slot name="default" />
        </div>
      </main>
    </div>
    ...
    <div
      v-if="slots.sidebar"
      class="hidden lg:flex w-[min(34rem,38vw)] min-w-[26rem] flex-col border-l border-n-weak bg-n-solid-2"
    >
      <div class="shrink-0">

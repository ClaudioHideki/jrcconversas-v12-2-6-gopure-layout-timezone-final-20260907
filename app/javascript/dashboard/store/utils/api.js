...
export const clearSessionStorageOnLogout = () => {
  ...
  SessionStorage.remove(SESSION_STORAGE_KEYS.IMPERSONATION_ACCOUNT_ID);
  SessionStorage.remove(SESSION_STORAGE_KEYS.IMPERSONATION_RETURN_TO);
};
...
export const clearCookiesOnLogout = ({ redirectTo } = {}) => {
  ...
  window.location = redirectTo || logoutRedirectLink;
};

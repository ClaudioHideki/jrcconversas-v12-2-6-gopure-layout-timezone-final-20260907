class SuperAdmin::Api::Channels::TwilioChannelsController < Api::V1::Accounts::Channels::TwilioChannelsController
  ...
  def create
    super
    render 'api/v1/accounts/channels/twilio_channels/create' unless performed?
  end

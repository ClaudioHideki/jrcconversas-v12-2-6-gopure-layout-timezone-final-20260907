...
unless Rails.env.production?
  ...
  user = User.new(name: 'JRC ADM', email: 'john@acme.inc', password: 'Password1!', type: 'SuperAdmin')
  ...
  inbox = Inbox.create!(channel: web_widget, account: account, name: 'Atendimento JRC')
